package com.eren.sprinboot.demosecurity.security;
...
public class DemoSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http.authorizeHttpRequests(configurer ->
                ...
                .formLogin(form -> // customizing the form login process
                        form.loginPage("/showMyLoginPage") //show our custom form at the request mapping "/showMyLoginPage"
